...
function DisModule()
{
    ...
    require XOOPS_ROOT_PATH . '/modules/' . $xoopsModule->dirname() . '/js/DisModule.js';
...
function DisBlock()
{
    ...
    require XOOPS_ROOT_PATH . '/modules/' . $xoopsModule->dirname() . '/js/DisBlock.js';
...
function DisHTMLPHP()
{
    ...
    require XOOPS_ROOT_PATH . '/modules/' . $xoopsModule->dirname() . '/js/DisHTMLPHP.js';
...
function DisHTMLJS()
{
    ...
    require XOOPS_ROOT_PATH . '/modules/' . $xoopsModule->dirname() . '/js/DisHTMLJS.js';
...
function DisHTMLASP()
{
    ...
    require XOOPS_ROOT_PATH . '/modules/' . $xoopsModule->dirname() . '/js/DisHTMLASP.js';
...
function DisHTMLJSP()
{
    ...
    require XOOPS_ROOT_PATH . '/modules/' . $xoopsModule->dirname() . '/js/DisHTMLJSP.js';
...
function DisHTMLPERL()
{
    ...
    require XOOPS_ROOT_PATH . '/modules/' . $xoopsModule->dirname() . '/js/DisHTMLPERL.js';
...
function DiSource()
{
    ...
    require XOOPS_ROOT_PATH . '/modules/' . $xoopsModule->dirname() . '/js/Dis.js';
...
function DisPop()
{
    ...
    require XOOPS_ROOT_PATH . '/modules/' . $xoopsModule->dirname() . '/js/popup.js';
...
function MTags()
{
    ...
    require XOOPS_ROOT_PATH . '/modules/' . $xoopsModule->dirname() . '/js/DisMTags.js';
...
function HelpModule()
{
  ...
  . '                                    size=\\&quot;7\\&quot;&gt;Disipal site&lt;/font&gt;&lt;/a&gt;&lt;/p&gt;&quot;; <br>'
  . '                                    CloseTable(); <br>'
  . '                                    require XOOPS_ROOT_PATH.&quot;/footer.php&quot;; <br>'
  . '                                    <br>'
  . '                                    ?&gt; <br>'
  . '&nbsp;</font></td>'
  . '                                  </tr>'
...
function HTMLSWS()
{
    ...
    require XOOPS_ROOT_PATH . '/modules/' . $xoopsModule->dirname() . '/js/HTMLSWS.js';
...
function EMAIL()
{
    ...
    require XOOPS_ROOT_PATH . '/modules/' . $xoopsModule->dirname() . '/js/emailencoder.js';
...
function ROT()
{
    ...
    require XOOPS_ROOT_PATH . '/modules/' . $xoopsModule->dirname() . '/js/rot.js';
...
function URLENCODER()
{
    ...
    require XOOPS_ROOT_PATH . '/modules/' . $xoopsModule->dirname() . '/js/URLCODER.js';
...
function PREVIEWER()
{
    ...
    require XOOPS_ROOT_PATH . '/modules/' . $xoopsModule->dirname() . '/js/PREVIEWER.js';
...
function HTMLENCODER()
{
    ...
    require XOOPS_ROOT_PATH . '/modules/' . $xoopsModule->dirname() . '/js/HTMLENCODER.js';
...
function SourceCoder()
{
    ...
    require XOOPS_ROOT_PATH . '/modules/' . $xoopsModule->dirname() . '/js/SourceCoder.js';
...
function DeDupe()
{
    ...
    require XOOPS_ROOT_PATH . '/modules/' . $xoopsModule->dirname() . '/js/TechDeDupe.js';
...
function ColorMatch()
{
    ...
    require XOOPS_ROOT_PATH . '/modules/' . $xoopsModule->dirname() . '/js/AC_RunActiveContent.js';
...
// catzwolf_ fix
$func = (isset($_GET['func']) and preg_match('/^[a-zA-Z0-9_\.\-`]*$/', $_GET['func'])) ? (string)$_GET['func'] : '';
